...
C/T	C/C	C/C	C/C
./.	C/C	C/C	./." > exp
gemini query -q "select (gts).(*)from variants" -ks extended_ped_db > obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*)from variants" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype=='1') from variants" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype=='1') from variants" \
             --gt-filter "[gt_type].[phenotype=='1'].[==HOM_REF].[all]" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype=='2') from variants" \
             --gt-filter "[gt_type].[phenotype=='2'].[!=HOM_REF].[all] && gt.M10478 =='A/A'" -ks extended_ped_db > obs
check obs exp
rm obs exp
...
chr10	135369531	135369532	T	C	T/T	T/T" > exp
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype=='1') from variants" \
             --gt-filter "[gt_type].[phenotype=='1'].[==HOM_REF].[any]" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
chr10	135336655	135336656	G	A	./.	A/A" > exp
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype=='1') from variants" \
             --gt-filter "[gt_type].[phenotype=='1'].[==HOM_REF].[none]" --test-mode -ks  extended_ped_db > obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==HET].[any]" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
chr10	135369531	135369532	T	C	T/T	T/T	T/C	T/C" > exp
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==HET].[count>0]" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
chr10	135369531	135369532	T	C	T/T	T/T	T/C	T/C" > exp
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==HET].[count>=2]" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
chr10	135369531	135369532	T	C	T/T	T/T	T/C	T/C" > exp
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==HOM_ALT].[count!=2]" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==HOM_ALT].[count!=2] && gt.M10478 =='G/G'" --test-mode -ks extended_ped_db > obs
check obs exp
rm obs exp
...
chr10	126678091	126678092	G	A	G/G	G/A	G/G	G/G" > exp
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==    HOM_ALT].[  count   !=2] && gt.M10478 =='G/G'" -ks extended_ped_db > obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==HOM_ALT].[]" -ks extended_ped_db 2> obs
check obs exp
rm obs exp
...
gemini query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
             --gt-filter "[gt_type].[*].[==HOM_ALT].[amy]" -ks extended_ped_db 2> obs
check obs exp
rm obs exp
