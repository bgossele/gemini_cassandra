...
\\The strong points of HBase are its strong consistency, which is rare among NoSQL-stores, and its concurrency model: ACID-compliant single row transactions and optimistic concurrency control using multiversioning for wider scope transactions\cite{hbase_acid}\cite{grolinger2013data}\cite{borthakur2011apache}.
