...
Om beperkingen op te leggen aan de variants waarin hij ge\"interesseerd is, kan de gebruiker SQL WHERE-clausules uitbreiden met zogenaamde genotype filters. Is hij bij voorbeeld enkel ge\"interesseerd in variants waarvoor Jan heterozygoot is en Mieke alles behalve heterozygoot is, kan dit met:\\
